...
import { createTeacherFormData, PaginatedTeachersResponse, Teacher, TeacherFormData, TeacherResponse } from "@/types/teacher";
...
export const TeacherApi = {
  ...
  getById: (id: number) =>
      axiosClient.get<TeacherResponse>(`/teachers/${id}`),
  ...
  update: (id: number, teacher: Partial<TeacherFormData>) => {
      ...
      return axiosClient.post<Teacher>(`/teachers/${id}`, formData, { // Use POST for FormData
          headers: { 'Content-Type': 'multipart/form-data' },
      });
