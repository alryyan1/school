                ...
                <motion.div key={grade.id} variants={itemVariants}>
                    <Card className="h-full flex flex-col">
                        ...
                        <CardContent className="flex-grow">
                            ...
                            <p className="text-lg font-semibold text-primary">{(grade.assignment_details?.basic_fees || 0).toLocaleString('en-US')} جنيه</p>
                        </CardContent>
                    ...
                    {assignedGradeLevels.map((grade) => (
                        <TableRow key={grade.id}>
                            ...
                            <TableCell className="font-semibold text-primary">
                                {(grade.assignment_details?.basic_fees || 0).toLocaleString('en-US')} جنيه
                            </TableCell>
                            <TableCell>
                                <Button variant="outline" size="sm" onClick={() => handleOpenEditFeeDialog(grade)}>
                                    <Edit3 className="ml-1.5 h-3.5 w-3.5" /> تعديل الرسوم
